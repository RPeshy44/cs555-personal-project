...
# This file contains the definition for the Elective class as well as all of the required information about each available elective course.
...
# Creates the list of all possible computer science elective courses.
def allElectives():
